...
const FoyerAbout = () => {
    ...
    return (
        <div className="room-section foyer-wrapper-clean bg-[#1C1208] text-[#f5f0e8] py-16 sm:py-24 px-4 sm:px-8 md:px-12 relative min-h-screen flex items-center" style={{ filter: 'none' }}>
            ...
            <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center w-full">
                {/* Left Column */}
                <div className="flex flex-col gap-8 order-2 lg:order-1 drop-shadow-[0_20px_40px_rgba(0,0,0,0.8)] p-4 sm:p-8">
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-white opacity-90 drop-shadow-md">
                        You Have Arrived.
                    </h2>

                    <div className="space-y-4 sm:space-y-6 text-base sm:text-lg text-[#f5f0e8]/90 leading-relaxed font-light font-serif drop-shadow-md">
                    ...
                    {/* Stats */}
                    <div className="stats-row flex flex-wrap justify-center sm:justify-between md:justify-start gap-x-8 gap-y-6 md:gap-x-24 uppercase tracking-[0.15em] sm:tracking-[0.2em] text-sm">
                        <div className="flex flex-col gap-2">
                            <span className="stat-projects text-3xl sm:text-4xl font-serif text-[#C9A84C]">0</span>
                            <span className="text-white/50">Projects</span>
                        </div>
                        <div className="flex flex-col gap-2">
                            <span className="stat-years text-3xl sm:text-4xl font-serif text-[#C9A84C]">0</span>
                            <span className="text-white/50">Years</span>
                        </div>
                        <div className="flex flex-col gap-2">
                            <span className="stat-cities text-3xl sm:text-4xl font-serif text-[#C9A84C]">0</span>
